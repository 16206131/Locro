...
@WebServlet("/post/sendPost")
//@MultipartConfig(location = "/postImages")
public class SendPostServlet extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean isEnjoy=postServices.enjoyPost(title,hometown,chineseDish,foreignDish,snacks,back,text,image,uid);
