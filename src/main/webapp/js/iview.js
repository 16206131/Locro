(function ($, window, undefined) {
    ...
    var iView = function (el, options) {
        ...
        $('.iview-caption', iv.slider).each(function (i) {
            var caption = $(this);
            $('<span class="caption-contain">' + caption.html() + '</span>').insertAfter(caption);
            caption.html('');//清除原有的字
        });
        //If randomStart
    ...
    iView.prototype = {
        ...
        setCaption: function () {
            ...
            captions.each(function (i) {
                ...
                var captionContain = $('.caption-contain');
                ...
                setTimeout(function () {
                    caption.animate({
                        ...
                        width: w,
                        height: h
                    }, speed, easing, function () {})}, timeEx);
                setTimeout(function () {
                    captionContain.animate({
                        opacity: iv.options.captionOpacityText,//文字透明度，增加属性
                        top: y+7,
                        left: x+5
                    }, speed, easing);
                }, (timeEx + 100));
