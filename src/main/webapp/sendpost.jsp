...
<div class="body_width">
    ...
    <div class="body_empty1" style="color: #ff4910; text-align:center; font-family: STXingkai;font-size:35px;">分享美食</div>

    <div class="body_left">

    <form method="post" action="/post/sendPost" enctype="multipart/form-data">
        ...
        <div class="postpage_box" style="height: 500px; margin-bottom: 10px; border: none" >
            <div class="navPadding_1">
                <textarea name="text" class="post_input" placeholder="请输入内容: " id="1" ></textarea>
            </div>
        </div>
