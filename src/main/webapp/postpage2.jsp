...
<div class="body_width">
    ...
    <div class="body_left">
        ...
        <div class="body_left_box" style="margin-bottom: 10px">
            <div class="body_left_box_picture"><img src="/images/food2.jpg" height=240px width=320px></div>
            <div class="body_left_box_title">【夏日凉爽主食】鱼子军舰寿司 </div>
            <div class="body_left_box_detail">&nbsp;</div>
            <div class=".body_left_box_info">
                <span class="body_left_box_username">Locro美食</span>
                <span class="body_left_box_date">2018年7月17日</span>
            </div>
        </div>

        <div class="postpage_box" style="height: 200px; margin-bottom: 10px">制作菜品所需的食材: </div>

        <!--正文-->
        <div class="postpage_box" style="height: 500px; margin-bottom: 10px">前两天女儿让我给她翻找一件她喜欢的玩具，无意间我看到以前家里吃海鲜剩下的贝壳，脑子一亮，我何不做一款贝壳形状的面包呢？说做就做，单纯的普通面包孩子已经没有兴趣了，好在前些日子老公过生日，给他做蛋糕还剩下了一些淡奶油和椰蓉，索性都放在里面，最终这款椰蓉馅奶油贝壳面包就诞生了。
        </div>
